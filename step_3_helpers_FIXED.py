...
def has_declared_conflict_in_class(
    ...
    """
    Επιστρέφει True αν υπάρχει δηλωμένη σύγκρουση μεταξύ του student_name
    και οποιουδήποτε μαθητή που βρίσκεται ήδη στο class_name.

    Ελέγχει και τις δύο κατευθύνσεις:
      - ο u έχει δηλώσει κάποιον από το cl στη ΣΥΓΚΡΟΥΣΗ του
      - κάποιος από το cl έχει δηλώσει τον u στη ΣΥΓΚΡΟΥΣΗ του
    """
